        ...
        <b-collapse id="nav-collapse" is-nav>
          ...
          <b-navbar-nav>
            ...
            <b-nav-item-dropdown right>
              ...
              <b-dropdown-item class="bg-info"><router-link :to="{name: 'PostList', params: {board_id: 1}}" >공지사항</router-link></b-dropdown-item>
              <b-dropdown-item class="bg-info"><router-link :to="{name: 'PostList', params: {board_id: 2}}" >자유게시판</router-link></b-dropdown-item>
              <b-dropdown-item class="bg-info"><router-link :to="{name: 'PostList', params: {board_id: 3}}" >운동관련정보</router-link></b-dropdown-item>
              <b-dropdown-item class="bg-info"><router-link :to="{name: 'PostList', params: {board_id: 4}}" >식단관련정보</router-link></b-dropdown-item>
            </b-nav-item-dropdown>
